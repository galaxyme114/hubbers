...
export default class ContestAttachments extends React.Component<ContestAttachmentsProps, ContestAttachmentsState> {
	...
	private static renderVideo(attachment: ContestEntryAttachmentRecord) {
		return (
			<div className="attachment_slider_img__wrap attachment_slider_img__wrap--video">
				<div className="attachment_slider_img">
					<div className="attachment--type-video">
						<Player>
