...
import { getOrientation } from '../utils/media'
...
export default class UserThumbnailUpload extends React.Component<UserThumbnailUploadProps, UserThumbnailUploadState> {
	...
	private uploadImage(file?: any) {
		...
		getOrientation(file)
			.then((uploadOrientation: number) => doUploadMedia((file ? file : this.state.uploadableFile),
				{dimensions: {width: 600, height: 600, crop: true}, uploadOrientation},
				(uploadProgress: number) => {
